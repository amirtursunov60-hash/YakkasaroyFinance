...
| `008_reopen_period.sql` | **нужно применить** | fp_reopen_period — переоткрытие закрытой недели (протокол Директивы удаляется, при повторном закрытии создаётся заново) |
