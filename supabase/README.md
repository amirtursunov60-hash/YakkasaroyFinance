...
| `006_directive.sql` | **нужно применить** | Директива: схема распределения по умолчанию (income_type_id nullable + сид 3 этапов) и функции fp_run_distribution / fp_close_period |
