...
| `004_seed.sql` | **нужно применить** | стартовые справочники прототипа: 6 точек, кассы и счета Алиф, фонды ФД1–ФД9/1, дерево D-кодов доходов, статьи РД (валюты и способы оплаты уже были залиты) |
