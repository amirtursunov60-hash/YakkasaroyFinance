...
- **Реестр:** поиск (§6), drill-down карточка операции (§10), справочник типов операций (§11).
...
- **Контрагенты:** адреса (§19), ответственные лица (§20), физ/юрлицо+реквизиты (§21), вложения-договоры (§22), архив в UI (§23).
