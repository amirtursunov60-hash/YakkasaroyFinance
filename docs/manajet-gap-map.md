...
- **Контрагенты:** ✅ адреса (§19), ✅ ответственные лица (§20), ✅ физ/юрлицо+реквизиты (§21) — закрыты (#186: `counterparties.entity_type`/`address`/`bank_name`/`bank_account`/`bank_mfo`/`contact_person` + поля в форме и на карточке). Осталось: вложения-договоры (§22). _Архив в UI (§23) — уже реализован вместе с #164 (тумблер «С архивом» + кнопка «В архив/Из архива» на карточке)._
