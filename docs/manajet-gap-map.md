...
- ⬜ **Рассылки клиентам (Massmail) + in-app уведомления** (Задачи §12,13) — нужна миграция (таблицы рассылок/уведомлений). _Сейчас есть только бейдж-счётчик «к рассмотрению» (NotifyBell) — это не лента уведомлений с состоянием «прочитано»._
