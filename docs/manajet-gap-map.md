...
- 🟡 **Рассылки клиентам (Massmail) + in-app уведомления** (Задачи §12,13). ✅ **In-app уведомления — сделаны:** таблица `notifications` + триггеры (новый комментарий/ответ Финдиректора по заявке, решение по заявке) + лента в `NotifyBell` (непрочитанные, «прочитать все», переход). Осталось: массовые рассылки клиентам (Massmail).
