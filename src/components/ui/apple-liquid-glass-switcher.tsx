...
// Карта смещения для SVG-фильтра «liquid glass» (feDisplacementMap).
// Один и тот же data-URI используется обоими фильтрами (#switcher и #toggler).
const DISP_MAP =
      ...
      <div className="switcher__filter">
        <svg>
          <filter id="switcher" primitiveUnits="objectBoundingBox">
            <feImage result="map" width="100%" height="100%" x="0" y="0" href={DISP_MAP} />
          ...
          <filter id="toggler" primitiveUnits="objectBoundingBox">
            ...
            <feDisplacementMap id="disp2" in="blur" in2="map" scale="0.5" xChannelSelector="R" yChannelSelector="G" />
          </filter>
        </svg>
      </div>
    </fieldset>
