...
export function FolderIcon() { return <svg width="16" height="16" viewBox="0 0 24 24" fill="#e8911c" style={{ flexShrink: 0 }}><path d="M10 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>; }
